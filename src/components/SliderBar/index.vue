<template>
    <div ref="bar-container" class="slider-bar-container" :style="containerStyle">
        ...
        <div
                ...
                @touchstart="appStartHandler1"
                @touchend="appEndHandler"
                @horizontalpan="appHandler1"
        ...
        <div
                ...
                @touchstart="appStartHandler2"
                @touchend="appEndHandler"
                @horizontalpan="appHandler2"
                :prevent-move-event="preventMoveEvent"
                :style="blockStyle2">
            <div></div>
        </div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            if (this.supportsEB() && Binding.prepare) {
        ...
        computed: {
            containerStyle() {
                return {
                    width: `${this.length + this.indicatorHeight}px`,
            ...
            blockStyle1() {
                ...
                return {
                    ...
                    width: `${this.indicatorHeight}px`,
                    height: `${this.indicatorHeight}px`,
                    borderRadius: `${this.indicatorHeight / 2}px`
                };
            },
            blockStyle2() {
                return {
        ...
        methods: {
            supportsEB () {
                return Binding.isSupportBinding && !this.isWeb();
            },

            isWeb () {
                const { platform } = app.config.env;
